      ...
      <fieldset>
        ...
        <div class="columns">
          ...
          <div class="item">
            ...
            ></div>
            <label class="d-block mb-1" for="sex">Gender<span>*</span></label>
          ...
          <div class="item">
            ...
            ></div>
            <label for="hes">HES (PAN) number<span>*</span></label>
            <input
              v-model.trim="$v.hes.$model"
              id="hes"
              type="text"
              name="hes"
              placeholder="33499483984"
            />
          ...
          <div class="item">
            ...
            <input
              ...
              type="email"
              name="email"
              placeholder="murthysriram@yahoo.com"
            />
