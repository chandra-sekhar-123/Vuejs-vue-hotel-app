<template>
  <main class="home">
    <h1 class="home-heading mb-0 bg-info">
      Murthy's Hotel,Flights and Cab booking
    </h1>
   
    <div class="home-text mb-5">
      <h4 class="bg-secondary text-warning">All at one place for you</h4>
    </div>
    ...
    <div class="destination-ideas">
     ...
     <h3 class="bg-dark text-light text-center">Copyright reserved to DSR Murthy</h3>
  </main>
</template>
